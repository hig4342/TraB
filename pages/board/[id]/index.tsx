  ...
  return (
    <div className='post' style={{width: '100%'}}>
      <Descriptions colon={false} column={1}>
        <Descriptions.Item label={post.board_state === 2 ? '공지사항)' : '제목:'} span={1} className='title-wrapper'><span>{post.title}</span></Descriptions.Item>
        <Descriptions.Item className='user-wrapper' span={1}>
        ...
        {post.board_state === 1 ? <Descriptions.Item className='content-wrapper' span={1}><div><img src={post.main_image}/></div></Descriptions.Item> : null }
        <Descriptions.Item className='content-wrapper' span={1}><div className='post-content'>{ ReactHtmlParser(post.content)}</div></Descriptions.Item>
      </Descriptions>
